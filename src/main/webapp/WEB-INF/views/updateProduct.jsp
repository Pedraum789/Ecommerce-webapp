	...
	<div id="signupbox" style="margin-top: 50px"
		...
		<div class="panel panel-info">
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="/ecommerceapp/addProduct.htm">Add Product</a></li>
				<li><a href="/ecommerceapp/viewProducts.htm">View Products</a></li>
				<li class="active"><a>Update Products</a></li>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:input type="text" class="form-control" name="productname"
								id="disabledInput" placeholder="Product Name" disabled="" path="name" />
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:input type="text" class="form-control" name="country"
								id="disabledInput" disabled="" placeholder="Picture URL" path="productPictureUrlString" />
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-9">
							<form:input type="textarea" class="form-control"
								...
								id="disabledInput" disabled="" path="description" />
						</div>
					</div>
					<div class="form-group">
						<!-- Button --><div class="col-md-offset-3 col-md-9" align="left">
							<button id="btn-signup" type="submit" name="action" value="Update" class="btn btn-info">
								<i class="icon-hand-left"></i>Update Product
							</button>
							<button id="btn-signup" type="submit" name="action" value="Delete" class="btn btn-info">
								<i class="icon-hand-right"></i>Delete Product
							</button>
						</div>
					</div>
				</form:form>
